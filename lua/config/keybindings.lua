...
-- peek
nmap('<leader>cpd', "<cmd>lua require('goto-preview').goto_preview_definition()<CR>", '[P]eek Definition')
nmap('<leader>cpt', "<cmd>lua require('goto-preview').goto_preview_type_definition()<CR>", '[P]eek Type Definition')
nmap('<leader>cpi', "<cmd>lua require('goto-preview').goto_preview_implementation()<CR>", '[P]eek Implementation')
nmap('<leader>cpc', "<cmd>lua require('goto-preview').goto_preview_declaration()<CR>", '[P]eek Type Declaration')
